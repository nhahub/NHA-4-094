...
SESS_CHAT = "e2e1e2e1-e2e1-e2e1-e2e1-e2e1e2e1e2e1"
SESS_EMPTY = "e2e2e2e2-e2e2-e2e2-e2e2-e2e2e2e2e2e2"
SESS_CHAT_B = "e2e3e2e3-e2e3-e2e3-e2e3-e2e3e2e3e2e3"
...
def main():
    print("=" * 60)
    print("        FASTAPI END-TO-END HTTP API RUNNER")
    print("=" * 60)
